        ...
        <div className="flex h-100 justify-center items-center">
          <div className='flex w-full justify-center items-center align-middle'>
            <div className='col-span-4  sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/3'>
              ...
              <button type="button" className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-4 py-2.5 text-center me-2 mb-2">Feedback</button>
            </div>
