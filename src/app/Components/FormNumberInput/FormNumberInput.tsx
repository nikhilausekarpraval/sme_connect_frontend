...
const NumberFormInput: React.FC<NumberFormInputProps>=({ validateField, fieldName, fieldValue, fieldLabel, handleInputChange, maxLength, required, className, isDisabled })=> {
        ...
        return (
            <div className={className ? "col col-sm-6 m-0 gap-5  align-items-center justify-content-start" : "mb-3 col col-sm-6 m-0 p-0 ps-3"}>
                ...
                <Form.Control disabled={isDisabled} type="text" autoComplete="off" required={required} className={validateField[fieldName] ? "border-danger" : ""} maxLength={maxLength} name={fieldName} onChange={handleInputChange} value={fieldValue} id={fieldName} />
